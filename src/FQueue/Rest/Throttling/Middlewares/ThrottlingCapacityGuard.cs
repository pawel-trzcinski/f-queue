...
namespace FQueue.Rest.Throttling.Middlewares
{
    public class ThrottlingCapacityGuard
    {
        ...
        private readonly ThrottlingConfiguration _throttlingConfiguration;
        ...
        private Task<EnqueueStatus> Enqueue(CancellationToken enqueueCancellationToken)
        {
            ...
            if (_throttlingConfiguration.QueueLimit > 0 && _queue.Count < _throttlingConfiguration.QueueLimit)
            {
        ...
        private CancellationToken GetTimeoutToken()
        {
            ...
            timeoutTokenSource.CancelAfter(_throttlingConfiguration.QueueTimeout);
